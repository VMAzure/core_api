...
async def gemini_auto_scenario(
    ...
    try:
        ...
        img_bytes = img_bytes_list[0]  # prima immagine
        _logger.info("STEP A generated bytes=%d time=%.2fs",
                     len(img_bytes or b""), time.perf_counter() - tA)
    ...
    try:
        ...
        _logger.info("STEP B generated bytes=%d time=%.2fs",
                     len(img_bytesB or b""), time.perf_counter() - tB)
