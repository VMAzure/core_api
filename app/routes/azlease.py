...
""")
    ...
    insert_values = {
        ...
        "codice_modello": modello.get("codDescModello", {}).get("codice"),
        ...
        "marca_nome": modello.get("marca", {}).get("nome"),
        "marca_acronimo": modello.get("marca", {}).get("acronimo"),
        ...
        "categoria": modello.get("categoria", {}).get("descrizione"),
        "segmento": modello.get("segmento", {}).get("descrizione"),
        "tipo": modello.get("tipo", {}).get("descrizione"),
        ...
        "cambio": modello.get("cambio", {}).get("descrizione"),
        "trazione": modello.get("trazione", {}).get("descrizione"),
        ...
        "alimentazione": modello.get("alimentazione", {}).get("descrizione"),
        "architettura": modello.get("architettura", {}).get("descrizione"),
